...
function addMenu(activeMenuItem) {
    ...
    else if (activeMenuItem == 'safety' || activeMenuItem == 'outside' || activeMenuItem == 'courses') {
        activeSubMenuItem = activeMenuItem;
    ...
    if (activeMenuItem) {
        ...
        if (activeMenuItem == 'visit' || activeMenuItem == 'climbing') {
            ...
            const dropdownElement = document.getElementById(activeMenuItem + '-dropdown');
            if (dropdownElement) {
    ...
    if (activeSubMenuItem) {
        const activeSubElement = document.getElementById('menu-' + activeSubMenuItem);
        if (activeSubElement) {
